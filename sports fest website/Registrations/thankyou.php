...
<h3 class="conf1">You have successfully registered for Pearl 15.</h3>

<p id="blah"><a href="index.php" id="link">Make another registration.</a></p>
<!--<form action="run.php" name="myForm" onsubmit="return( validate() );" method="post" target="">
			...
			<div class="conf">
				...
				<h3 class="conf1"><label for="conf" id="conf1" class="conf1" visibility: hidden;>You have successfully registered for Pearl 15.&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</label></h3>
			</div>
				<label for="firstname" id="fn" class="">First-Name :&nbsp &nbsp &nbsp &nbsp &nbsp</label>
				<input type="text" maxlength="25" name="firstname" id="firstname" class="fn" onfocus="funon( this );" onblur="funoff( this );" required/> <br><br>
				...
				<div class="gam">
				<label for="sport" id="game" class="">Event mainly interested in :    &nbsp &nbsp &nbsp</label>
				<select name="sport">
