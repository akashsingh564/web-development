	...
	<form action="run.php" name="myForm" onsubmit="return( validate() );"  method="POST" accept-charset="UTF-8" enctype="application/x-www-form-urlencoded" autocomplete="off">
		<fieldset>
			...
			<div class="field">
				...
				<div class="input"><input type="text" maxlength="25" name="fname" required /></div>
			</div>
			
			<div class="field">
				<div class="label"><label for="lname">Last-name :&nbsp; &nbsp; </label> </div>
				<div class="input"><input type="text" maxlength="25" name="lname" required /> </div>
			</div>
			
			<div class="field">
				<div class="label"><label for="college">College :&nbsp; &nbsp; </label> </div>
				<div class="input"><input type="text" maxlength="60" name="college" required /> </div>
			</div>
			...
			<div class="field">
				...
				<div class="input"><input type="text" maxlength="60" name="event" required /> </div>
			</div>
			
			<div class="field">
				<div class="label"><label for="contact">Contact Number :&nbsp; &nbsp; </label> </div>
				<div class="input"><input type="number" maxlength="10" name="contact" required /></div>
			</div>	
			
			<div class="field">
				<div class="label"><label for="email">E-Mail address :&nbsp; &nbsp; </label> </div>
				<div class="input"><input type="email" maxlength="40" name="email" required /></div>
			</div>	
